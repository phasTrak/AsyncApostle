...
namespace AsyncApostle.Helpers
{
    public static class TypeHelper
    {
        ...
        static bool EqualSubstitutions(ITypeElement referenceOwner, ISubstitution referenceSubstitution, ITypeElement originOwner, ISubstitution originSubstitution)
        {
