...
public static class TypeHelper
{
   ...
   extension(IType type)
   {
      ...
      public IType? GetFirstGenericType()
      {
      ...
      public bool IsAsyncDelegate(IType otherType)
      {
      ...
      public bool IsEquals(IType otherType)
      {
   ...
   extension(IType? type)
   {
      ...
      [Pure] [ContractAnnotation("null => false")] public bool IsGenericIQueryable() => type is IDeclaredType declaredType && IsPredefinedTypeElement(declaredType.GetTypeElement(), GENERIC_IQUERYABLE_FQN);

      [Pure]
      [ContractAnnotation("type:null => false; otherType:null => false")]
      public bool IsGenericTaskOf(IType? otherType) =>
         type is not null
      ...
      [Pure]
      [ContractAnnotation("type:null => false; otherType:null => false")]
      public bool IsTaskOf(IType? otherType) => type.IsTask() && otherType.IsVoid() || type.IsGenericTaskOf(otherType);
   }
}